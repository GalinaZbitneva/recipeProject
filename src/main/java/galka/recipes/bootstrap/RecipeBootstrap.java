package galka.recipes.bootstrap;

import galka.recipes.domain.Category;
import galka.recipes.domain.Difficulty;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes(){
        ...
        //get UOMs проверяем , что они есть в репозитории
        ...
        //теперь проверяем в categoryRepository что у нас существуют указанные категории
